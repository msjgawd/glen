...
$(document).ready(function () {
    var footerhtml = '<div class="footer" id="footer" style="background-color: #d3d3d3"><div class="copyright_by center_vertical height100p"><p class="footer">Created by <a class="footer" target="_blank" href="http://msjwave.com">MSJWAVE 2015</a></p></div></div>';
